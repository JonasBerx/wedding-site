...
function MenuSection({ t, fonts }) {
  return (
    <section style={{ padding: '90px 120px 100px', borderTop: `1px solid ${t.rule}` }}>
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80 }}>
        {[['First', MENU.first], ['Main', MENU.main]].map(([heading, items], colIdx) => (
          <div key={heading}>
            <div style={{
              ...
              <span style={{
                fontFamily: fonts.script, fontSize: 38, lineHeight: 1,
            ...
            <div>
              {items.map((item, i) => (
                <div key={item.id} style={{
                  ...
                  <div style={{
                    fontFamily: fonts.head, fontStyle: 'italic', fontSize: 24,
                    color: t.ink, lineHeight: 1.2, marginBottom: 6,
                  }} dangerouslySetInnerHTML={{ __html: item.name }} />
                  <div style={{
                    fontFamily: fonts.body, fontStyle: 'italic', fontSize: 16,
